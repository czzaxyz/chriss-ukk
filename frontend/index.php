...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="templates/assets/fonts/themify-icons.css">
		<!--- owl carousel Css-->
		<link rel="stylesheet" href="templates/assets/owlcarousel/css/owl.carousel.css">
		<link rel="stylesheet" href="templates/assets/owlcarousel/css/owl.theme.css">	
		<!--jquery-simple-mobilemenu Css-->
        <link rel="stylesheet" href="templates/assets/css/jquery-simple-mobilemenu.css">			
		<!-- MAGNIFIC CSS -->
    ...
    <body data-spy="scroll" data-offset="80">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-20 align-self-center">
						<div class="site-logo">
							<a href="index.html"><img src="templates/assets/img/logo.png" alt=""></a>          				
						</div>
					</div><!--- END Col -->
		...
		<!-- START HOME -->
		<section class="home_bg hb_height" style="background-image: url(templates/assets/img/bg/home-bg.jpg);  background-size:cover; background-position: center center;">
			<div class="container">
				<div class="row">
				  ...
				  <div class="col-lg-6 col-sm-12 col-xs-12">
					<div class="hero-text-img">
						<img src="templates/assets/img/home-img2.png" class="img-fluid" alt="" />
						<div class="home_ps">
	...
	<!-- START CATEGORY -->
	<section class="top_cat__area section-padding" style="background-image: url(templates/assets/img/bg/shape-1.png);  background-size:cover; background-position: center center;">
		<div class="container">									
		...
		<div class="container">									
			<div class="row">								
				<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
					<div class="ab_img">
						<img src="templates/assets/img/about1.png" class="img-fluid" alt="image">
					</div>
				</div><!--- END COL -->						
	...
	<!-- START CATEGORY -->
	<section class="top_cat__area section-padding" style="background-image: url(templates/assets/img/bg/section-2.jpg);  background-size:cover; background-position: center center;">
		<div class="container">									
			<div class="section-title text-center">
			...
			<div class="row">													
				<div class="col-lg-12 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
					<div class="cat_list">
						<ul>
							<li><a href="#"><img src="templates/assets/img/e1.png" alt="category-image" /> Digital Marketing</a></li>
							<li><a href="#"><img src="templates/assets/img/e2.png" alt="category-image" /> UI/UX Design</a></li>
							<li><a href="#"><img src="templates/assets/img/e3.png" alt="category-image" /> 3D Visual Design</a></li>
							<li><a href="#"><img src="templates/assets/img/e4.png" alt="category-image" /> Content Marketing</a></li>
							<li><a href="#"><img src="templates/assets/img/e5.png" alt="category-image" /> Photography</a></li>
							<li><a href="#"><img src="templates/assets/img/e6.png" alt="category-image" /> Photo Lifestyle</a></li>
							<li><a href="#"><img src="templates/assets/img/e7.png" alt="category-image" /> Art & Design</a></li>
							<li><a href="#"><img src="templates/assets/img/e8.png" alt="category-image" /> Finance & Banking</a></li>
							<li><a href="#"><img src="templates/assets/img/e9.png" alt="category-image" /> Graphic Design</a></li>
							<li><a href="#"><img src="templates/assets/img/e2.png" alt="category-image" /> Interior Design</a></li>
							<li><a href="#"><img src="templates/assets/img/e3.png" alt="category-image" /> 3D Visual Design</a></li>	
							<li><a href="#"><img src="templates/assets/img/e7.png" alt="category-image" /> Art & Design</a></li>							
						</ul>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/1.png" class="img-fluid" alt="course-image" />
								<span>Education</span>
							</div>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/2.png" class="img-fluid" alt="course-image" />
								<span>UI/UX</span>
							</div>
							<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/3.png" class="img-fluid" alt="course-image" />
								<span>Lifestyle</span>
							</div>
							<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/4.png" class="img-fluid" alt="course-image" />
								<span>Science</span>
							</div>
							<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/5.png" class="img-fluid" alt="course-image" />
								<span>Modern</span>
							</div>
							<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
					...
					<div class="col-lg-4 col-sm-6 col-xs-12">
						<div class="single_course">
							<div class="single_c_img">
								<img src="templates/assets/img/course/6.png" class="img-fluid" alt="course-image" />
								<span>Marketing</span>
							</div>
							<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
			...
			<div class="container">
				<div class="row part_bg">
					...
					<div class="col-lg-8 col-sm-8 col-xs-12 text-center">
						<div class="partner">
							<a href="#"><img src="templates/assets/img/clients/1.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/2.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/3.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/4.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/5.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/2.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/1.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/3.png" alt="image"></a>
							<a href="#"><img src="templates/assets/img/clients/4.png" alt="image"></a>
			...
			<div class="container">																
				<div class="row">
					<div class="col-lg-12 vp_top wow fadeInUDown" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
						<div class="video-area" style="background-image: url(templates/assets/img/bg/video.jpg);  background-size:cover; background-position: center center;">
			...
			<div class="container">									
				...
				<div class="row">													
					<div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="our-team">
							<div class="team-content">
								<a href="#"><img src="templates/assets/img/team/team1.jpg" alt=""></a>
					...
					<div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="our-team">
							<div class="team-content">
								<a href="#"><img src="templates/assets/img/team/team2.jpg" alt=""></a>
								<ul class="social-links">
									<li><a href="#"><i class="fa-solid fa-x"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
					...
					<div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="our-team">
							<div class="team-content">
								<a href="#"><img src="templates/assets/img/team/team3.jpg" alt=""></a>
								<ul class="social-links">
									<li><a href="#"><i class="fa-solid fa-x"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
					...
					<div class="col-lg-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="our-team">
							<div class="team-content">
								<a href="#"><img src="templates/assets/img/team/team4.jpg" alt=""></a>
								<ul class="social-links">
									<li><a href="#"><i class="fa-solid fa-x"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-facebook-f"></i></a></li>
									<li><a href="#"><i class="fa-brands fa-linkedin-in"></i></a></li>
	...
	<section class="ab_area section-padding">
		<div class="container">									
			<div class="row">													
				...
				<div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s" data-wow-offset="0">
					<div class="ab_img">
						<img src="templates/assets/img/about3.png" class="img-fluid" alt="image">
						<div class="home_ps2">
		...
		<section class="testi_area section-padding">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-6 col-sm-12 col-xs-12">
						<div class="ab_img">
							<img src="templates/assets/img/review.png" class="img-fluid" alt="image">
						</div>					
					</div><!-- END COL -->						
					<div class="col-lg-6 col-sm-12 col-xs-12">
						<div id="testimonial-slider" class="owl-carousel">
							<div class="testimonial">
								<img src="templates/assets/img/quote.png" alt="" />
								...
								<div class="testi_pic_title">
									<img src="templates/assets/img/testimonial/1.png" alt="">
									<h4>Ajmain Adil</h4>
									<p>Groton Inc</p>
								</div>
							</div><!-- END TESTIMONIAL -->
							...
							<img src="templates/assets/img/quote.png" alt="" />
								...
								<div class="testi_pic_title">
									<img src="templates/assets/img/testimonial/2.png" alt="">
									<h4>Sharukh Khan</h4>
									<p>Red Chili Inc</p>
								</div>
							</div><!-- END TESTIMONIAL -->
							<div class="testimonial">
								...
								<div class="testi_pic_title">
									<img src="templates/assets/img/testimonial/3.png" alt="">
							...
							<div class="testimonial">
								...
								<div class="testi_pic_title">
									<img src="templates/assets/img/testimonial/4.png" alt="">
									<h4>Ajmain Adil</h4>
									<p>Groton Inc</p>
								</div>
							</div><!-- END TESTIMONIAL -->
							<div class="testimonial">
								...
								<div class="testi_pic_title">
									<img src="templates/assets/img/testimonial/5.png" alt="">
									<h4>Ajmain Adil</h4>
									<p>Groton Inc</p>
								</div>
							</div><!-- END TESTIMONIAL -->
				...
				<div class="row">		
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_blog">
							<img src="templates/assets/img/blog/1.jpg" class="img-fluid" alt="image" />
					...
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
						<div class="single_blog">
							<img src="templates/assets/img/blog/2.jpg" class="img-fluid" alt="image" />
							<div class="content_box">
					...
					<div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
						<div class="single_blog">
							<img src="templates/assets/img/blog/3.jpg" class="img-fluid" alt="image" />
							<div class="content_box">
				...
				<div class="row">						
					...
					<div class="col-lg-2 col-sm-6 col-xs-12">
						<div class="single_footer">
							...
							<a href="index.html"><img src="templates/assets/img/google-play.jpg" class="foot_img" alt=""></a>  
							<a href="index.html"><img src="templates/assets/img/app-store.jpg" class="foot_img" alt=""></a>  
						</div>
					</div><!--- END COL -->	
				</div><!--- END ROW -->					
			</div><!--- END CONTAINER -->
