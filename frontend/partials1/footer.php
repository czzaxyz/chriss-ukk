...
<div class="footer section-padding">
    <div class="container">
        <div class="row">
                ...
                <div class="single_footer">
                    ...
                    <div class="social_profile">
                        <ul>
                            ...
                            <li><a class="f_twitter" href="#"><i class="fa-solid fa-x"></i></a></li>
            ...
            <div class="col-lg-2 col-sm-6 col-xs-12">
                <div class="single_footer">
                    <h4>Peminjaman Motor</h4>
                    <p>"Bukan sekadar motor, tapi ini adalah cara kami menikmati kebebasan.
                        Setiap putaran gas adalah cerita, setiap tikungan adalah petualangan,
                        dan setiap perjalanan adalah kenangan yang tak terlupakan."</p>
                </div>
            </div><!--- END COL -->
        </div><!--- END ROW -->
    </div><!--- END CONTAINER -->
